...
router.post(
  ...
  [
    ...
    body('section').if(body('role').equals('student')).trim().notEmpty().withMessage('Section is required for students'),
    body('className').if(body('role').equals('student')).optional().trim().escape().notEmpty().withMessage('Class name is optional but cannot be empty'),
    body('admissionYear').if(body('role').equals('student')).notEmpty().withMessage('Admission year is required for students'),
    // Faculty-specific
    body('department').if(body('role').equals('faculty')).trim().escape().notEmpty().withMessage('Department is required for faculty'),
    body('designation').if(body('role').equals('faculty')).trim().escape().notEmpty().withMessage('Designation is required for faculty'),
